...
async def request_email_update(
    ...
    """
    Send OTP to new email to update the current user's email.
    """
    ...
    # Record attempt
    await email_update_limiter.increment_attempts(new_email)
...
async def confirm_email_update(
    ...
    """
    Verify OTP and update current user's email.
    """
    user_id = current["user_id"]
    new_email = data.email.lower().strip()
